...
from pymongo import MongoClient  # Corrected the typo here
from datetime import datetime 

cluster = MongoClient("mongodb+srv://sadiqsmasher5:admin@cluster0.803fvvj.mongodb.net/?retryWrites=true&w=majority")
db = cluster["Landroute"]
users = db["users"]
orders = db["Orders"]
...
def reply():
    ...
    if bool(user) == False:
        msg = res.message("Hi, thanks for contacting *The LandRoute Bakers*.\nYou can choose from one of the options below: "
        ...
        if option == 1:
            res.message(
                "You can contact us through phone or e-mail.\n\n*Phone*: 993029025091 \n*E-mail* : contact@wajahatsmasher@gmail.com")
        elif option == 2:
            ...
            res.message("We work from *9 a.m. to 10 p.m*.")

        elif option == 4:
            res.message(
                "We have multiple stores across the city. Our main center is at *G6/2, BlueArea Islamabad*")
        else:
            res.message("Please enter a valid response")
